...
model_1 <- glm(dvote ~ income + gender, family = binomial, data = nes)
...
```
estimate -- divided by 4 is the effect of that variable at the steepest part of the logistic regression curve
